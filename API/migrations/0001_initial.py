    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="queued_song", through="API.QueueOrder", to="API.Song"
            ),
        ),
        migrations.CreateModel(
            name="PlaylistSong",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("user", "artist"), name="unique_followers"
            ),
        ),
    ]
